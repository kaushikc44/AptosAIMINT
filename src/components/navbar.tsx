...
function Navbar(props:addressprops){
    ...
    return (
        <>
            ...
            <nav className="flex justify-between items-center bg-opacity-0 bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded  " >
                ...
                <div className=" w-full md:w-auto md:order-1 bg-opacity-0" >
                    ...
                    <ul className="flex flex-col p-4 mt-4  rounded-lg   md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0  ">
                        <li>
                        <a href="#" className="block py-2 pl-3 pr-4 bg-opacity-0 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white" aria-current="page">Prompt</a>
                        </li>
                        <li>
